node ('v8s-dpcli-prov') {
   ...
   // --------------------------Bulk Inserts------------------------------------
   stage 'Ready env for Bulk Insets'
   sh 'mv inventory-app/dataimport/dealerships/Dockerfile inventory-app/dataimport/dealerships/Dockerfile.line.sav'
   sh 'mv inventory-app/dataimport/dealerships/Dockerfile.bulk.sav inventory-app/dataimport/dealerships/Dockerfile'
   sh 'mv inventory-app/dataimport/vehicles/Dockerfile inventory-app/dataimport/vehicles/Dockerfile.line.sav'
   sh 'mv inventory-app/dataimport/vehicles/Dockerfile.bulk.sav inventory-app/dataimport/vehicles/Dockerfile'
   // ------------------------ First test to run -------------------------------
